        ...
        issuance ?
          <div className="flex gap-x-2 ">
            <div>  <PricingDownloadLink
              ...
              hidePaperClip={true}
              clickableElement={<><ArrowDownTrayIcon aria-hidden="true" className="h-6 w-5 text-muted" ></ArrowDownTrayIcon><span className="sr-only">{labels.work.downloadInvoice}</span></>} >
              ...
              {offerIssuance &&
                <>
                  <div>  <PricingDownloadLink
                    ...
                    hidePaperClip={true}
                    hideLabel={false}
                    clickableElement={<><ArrowDownTrayIcon aria-hidden="true" className="h-6 w-5 text-muted" ></ArrowDownTrayIcon><span className="sr-only">{labels.work.downloadEstimate}</span></>} >
                  </PricingDownloadLink> </div>
